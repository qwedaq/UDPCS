...
class PACS(ImageList):
    ...
    image_list = {
        "A": "image_list/art_painting.txt",
        "C": "image_list/cartoon.txt",
        "P": "image_list/photo.txt",
        "S": "image_list/sketch.txt"
    }
    ...
    def __init__(self, root: str, task: str, split='all', download: Optional[bool] = True, **kwargs):
        ...
        print("printing data_list_file", data_list_file)
        ...
        super(PACS, self).__init__(root, PACS.CLASSES, data_list_file=data_list_file, 
                                   **kwargs)
