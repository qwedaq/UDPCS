...
######
# from torchvision.models.resnet import BasicBlock, Bottleneck, ResNet50_Weights
...
# ADDED THE MODEL LINKS TO SUPPORT NEW VERSION OF TORCHVISION
model_urls = {
...
def _resnet(arch, block, layers, pretrained, progress, **kwargs):
    ...
    if pretrained:
        ...
        ## NOT WORKING IN NEWER VERSION OF TORCHVISION AND OLD VERSION IS OUTDATED
